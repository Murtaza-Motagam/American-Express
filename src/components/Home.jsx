          ...
          <>
            <main className="container mt-5 " >
                    <div className="container my-5">
                        ...
                        <div class="row p-4 pb-0 pe-lg-0 align-items-center rounded-3 bg-light bs-1">
                            <div class="col-lg-7 p-3 pt-lg-2">

                                <h1 class="display-4 fw-bold lh-1 fw-bold placeholder">Welcome to <span className=" placeholder ">American-</span><span className=' placeholder'>Express</span> Bank</h1>
                                <span className="fs-5 my-3 placeholder">America's Most Trusted Bank</span>
                                <p class="fs-4 my-3 font-fam-roboto placeholder">Earn FD like interest up to 7%* p.a. in Savings Account with ActivMoney.</p>
                                ...
                                <p class="placeholder  mt-5 font-fam-roboto text-primary" style={{ fontSize: "17px" }}>5% off on opening DEMAT Account: Powered by American-Express.</p>
                            </div>
                            <div class="placeholder col-lg-4 offset-lg-1 p-0 overflow-hidden p-4">
                                <img class="placeholder " className="d-none img-fluid" src={require('../images/heroImg.jpg')} alt="" height="320px" />
                            </div>
                        </div>
                    </div>
        ...
        return (
            <>
                <main className="container mt-5 " >
                    <div className="container my-5">
                        ...
                        <div class="row p-4 pb-0 pe-lg-0 align-items-center rounded-3 bg-light bs-1">
                            <div class="col-lg-7 p-3 pt-lg-2">
                                ...
                                <h1 class="display-4 fw-bold lh-1 fw-bold">Welcome to <span className="brand-look">American-</span><span className='brand-look-2'>Express</span> Bank</h1>
                                <span className="fs-5 my-3">America's Most Trusted Bank</span>
                                <p class="fs-4 my-3 font-fam-roboto ">Earn FD like interest up to 7%* p.a. in Savings Account with ActivMoney.</p>
                                <p className="lead my-3 font-fam-roboto" style={{ marginLeft: "-10px" }}>
                                    ...
                                    <Link to="/" className="fw-bold button-24 btn-lg font-fam-roboto mx-2">Know More</Link>
                                </p>
                                <p class=" mt-5 font-fam-roboto text-primary" style={{ fontSize: "17px" }}>5% off on opening DEMAT Account: Powered by American-Express.</p>
                            </div>
                            <div class="col-lg-4 offset-lg-1 p-0 overflow-hidden p-4">
                                <img class="" className="img-fluid" src={require('../images/heroImg.jpg')} alt="" height="320px" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="mt-5 section-title" data-aos="fade-in" data-aos-delay="100">
                        <h2>Loan Schemes</h2>
                    </div>
